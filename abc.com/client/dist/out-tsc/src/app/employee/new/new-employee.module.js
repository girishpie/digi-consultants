...
var new_employee_component_1 = require("./new-employee.component");
...
NewEmployeeModule = __decorate([
    core_1.NgModule({
        ...
        exports: [new_employee_component_1.NewEmployeeComponent],
        providers: [],
        bootstrap: []
    })
], NewEmployeeModule);
exports.NewEmployeeModule = NewEmployeeModule;
